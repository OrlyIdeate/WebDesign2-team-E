    ...
    <>
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <div style={{ display: 'flex', flex: 1, justifyContent: 'center', alignItems: 'center' }}>
          ...
          <div style={{ padding: '20px', width: '100%', backgroundColor: '#E8E8E8', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <div>
              {[...Array(2)].map((_, rowIndex) => (
                <div key={rowIndex} style={{ marginBottom: '20px', display: 'flex', justifyContent: 'center' }}>
